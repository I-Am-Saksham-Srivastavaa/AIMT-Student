...
import 'fee_record_overview_model.dart';
export 'fee_record_overview_model.dart';

class FeeRecordOverviewWidget extends StatefulWidget {
  const FeeRecordOverviewWidget({super.key});

  @override
  State<FeeRecordOverviewWidget> createState() =>
      _FeeRecordOverviewWidgetState();
}

class _FeeRecordOverviewWidgetState extends State<FeeRecordOverviewWidget> {
  late FeeRecordOverviewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FeeRecordOverviewModel());
