...
import 'faculty_list_compenent_model.dart';
export 'faculty_list_compenent_model.dart';

class FacultyListCompenentWidget extends StatefulWidget {
  const FacultyListCompenentWidget({super.key});

  @override
  State<FacultyListCompenentWidget> createState() =>
      _FacultyListCompenentWidgetState();
}

class _FacultyListCompenentWidgetState
    extends State<FacultyListCompenentWidget> {
  late FacultyListCompenentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FacultyListCompenentModel());
