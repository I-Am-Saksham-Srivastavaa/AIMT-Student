...
import 'resource_comp_model.dart';
export 'resource_comp_model.dart';

class ResourceCompWidget extends StatefulWidget {
  const ResourceCompWidget({super.key});

  @override
  State<ResourceCompWidget> createState() => _ResourceCompWidgetState();
}

class _ResourceCompWidgetState extends State<ResourceCompWidget> {
  late ResourceCompModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ResourceCompModel());
