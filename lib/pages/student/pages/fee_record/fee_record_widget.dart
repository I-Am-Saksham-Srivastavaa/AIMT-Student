...
import 'fee_record_model.dart';
export 'fee_record_model.dart';

class FeeRecordWidget extends StatefulWidget {
  const FeeRecordWidget({super.key});

  @override
  State<FeeRecordWidget> createState() => _FeeRecordWidgetState();
}

class _FeeRecordWidgetState extends State<FeeRecordWidget>
    with TickerProviderStateMixin {
  late FeeRecordModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FeeRecordModel());
