                          ...
                          child: Column(
                            ...
                            children: [
                                                    ...
                                                    padding:
                                                        const EdgeInsetsDirectional
                                                            .fromSTEB(0.0, 4.0,
                                                                0.0, 0.0),
                                                    child: Text(
                                                      'Below is a your Academic Record',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .labelMedium,
                              ...
                              Column(
                                ...
                                children: [
                                  wrapWithModel(
                                    model: _model.academicSummaryModel,
                                    updateCallback: () => setState(() {}),
                                    child: const AcademicSummaryWidget(),
                                  ),
                                  Align(
                                  ...
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 0.0, 12.0),
                                    child: wrapWithModel(
                                      model: _model.academicOverviewModel,
                                      updateCallback: () => setState(() {}),
                                      child: const AcademicOverviewWidget(),
                                    ),
                                  ),
                                  Align(
                                    alignment: const AlignmentDirectional(-1.0, 0.0),
