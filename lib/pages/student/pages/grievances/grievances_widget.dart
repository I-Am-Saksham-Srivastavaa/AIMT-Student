...
export 'grievances_model.dart';

class GrievancesWidget extends StatefulWidget {
  const GrievancesWidget({super.key});

  @override
  State<GrievancesWidget> createState() => _GrievancesWidgetState();
}

class _GrievancesWidgetState extends State<GrievancesWidget>
    with TickerProviderStateMixin {
  late GrievancesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GrievancesModel());
                                                ...
                                                Padding(
                                                  padding: const EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 4.0, 0.0, 0.0),
                                                  child: Text(
                                                    'Below are the Grievances Sevices',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .labelMedium,
                                                  ),
