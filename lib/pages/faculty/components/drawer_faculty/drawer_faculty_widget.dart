...
import 'drawer_faculty_model.dart';
export 'drawer_faculty_model.dart';

class DrawerFacultyWidget extends StatefulWidget {
  const DrawerFacultyWidget({
    super.key,
  ...
  @override
  State<DrawerFacultyWidget> createState() => _DrawerFacultyWidgetState();
}

class _DrawerFacultyWidgetState extends State<DrawerFacultyWidget>
    with TickerProviderStateMixin {
  late DrawerFacultyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DrawerFacultyModel());
