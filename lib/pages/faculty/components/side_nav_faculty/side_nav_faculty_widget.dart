...
import 'side_nav_faculty_model.dart';
export 'side_nav_faculty_model.dart';

class SideNavFacultyWidget extends StatefulWidget {
  const SideNavFacultyWidget({
    super.key,
  ...
  @override
  State<SideNavFacultyWidget> createState() => _SideNavFacultyWidgetState();
}

class _SideNavFacultyWidgetState extends State<SideNavFacultyWidget>
    with TickerProviderStateMixin {
  late SideNavFacultyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SideNavFacultyModel());
                      ...
                      MouseRegion(
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              context.pushNamed('SettingsFaculty');
                            },
                            child: AnimatedContainer(
                              duration: const Duration(milliseconds: 200),
                              curve: Curves.easeInOut,
