...
class AttendanceRecordWidget extends StatefulWidget {
  const AttendanceRecordWidget({super.key});
...
class _AttendanceRecordWidgetState extends State<AttendanceRecordWidget>
  ...
  late AttendanceRecordModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AttendanceRecordModel());
                        ...
                        children: [
                                              ...
                                              Padding(
                                                padding: const EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 4.0, 0.0, 0.0),
                                                child: Text(
                                                  'Below is your Attendance Record of all the students',
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              wrapWithModel(
                                model: _model.attendanceSummaryFacultyModel,
                                updateCallback: () => setState(() {}),
                                child: const AttendanceSummaryFacultyWidget(),
                              ),
                            ],
                          ),
