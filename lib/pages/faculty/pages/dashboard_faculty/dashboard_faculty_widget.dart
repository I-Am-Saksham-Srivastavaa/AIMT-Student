...
import 'dashboard_faculty_model.dart';
export 'dashboard_faculty_model.dart';

class DashboardFacultyWidget extends StatefulWidget {
  const DashboardFacultyWidget({super.key});

  @override
  State<DashboardFacultyWidget> createState() => _DashboardFacultyWidgetState();
}

class _DashboardFacultyWidgetState extends State<DashboardFacultyWidget>
    with TickerProviderStateMixin {
  late DashboardFacultyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DashboardFacultyModel());
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                wrapWithModel(
                                  model: _model.attendanceOverviewFacultyModel,
                                  updateCallback: () => setState(() {}),
                                  child: const AttendanceOverviewFacultyWidget(),
                                ),
                                wrapWithModel(
