...
import 'faculty_list_model.dart';
export 'faculty_list_model.dart';

class FacultyListWidget extends StatefulWidget {
  const FacultyListWidget({super.key});

  @override
  State<FacultyListWidget> createState() => _FacultyListWidgetState();
}

class _FacultyListWidgetState extends State<FacultyListWidget>
                                                ...
                                                Padding(
                                                  padding: const EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 4.0, 0.0, 0.0),
                                                  child: Text(
                                                    'Below is a list of all faculty members',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .labelMedium,
                                                  ),
