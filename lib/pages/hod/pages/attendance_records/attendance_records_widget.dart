...
import 'attendance_records_model.dart';
export 'attendance_records_model.dart';

class AttendanceRecordsWidget extends StatefulWidget {
  const AttendanceRecordsWidget({super.key});
...
class _AttendanceRecordsWidgetState extends State<AttendanceRecordsWidget>
  ...
  late AttendanceRecordsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AttendanceRecordsModel());
                                              ...
                                              Padding(
                                                padding: const EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 4.0, 0.0, 0.0),
                                                child: Text(
                                                  'Below is your Attendance Record ',
