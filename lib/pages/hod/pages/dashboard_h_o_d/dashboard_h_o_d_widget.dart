...
import 'dashboard_h_o_d_model.dart';
export 'dashboard_h_o_d_model.dart';

class DashboardHODWidget extends StatefulWidget {
  const DashboardHODWidget({super.key});

  @override
  State<DashboardHODWidget> createState() => _DashboardHODWidgetState();
}

class _DashboardHODWidgetState extends State<DashboardHODWidget>
    with TickerProviderStateMixin {
  late DashboardHODModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DashboardHODModel());
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  wrapWithModel(
                                    model: _model.attendanceOverviewHODModel,
                                    updateCallback: () => setState(() {}),
                                    child: const AttendanceOverviewHODWidget(),
                                  ),
                                ],
                              ),
                              wrapWithModel(
