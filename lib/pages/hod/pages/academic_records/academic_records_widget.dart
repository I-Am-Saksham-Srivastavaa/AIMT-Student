...
import 'academic_records_model.dart';
export 'academic_records_model.dart';

class AcademicRecordsWidget extends StatefulWidget {
  const AcademicRecordsWidget({super.key});

  @override
  State<AcademicRecordsWidget> createState() => _AcademicRecordsWidgetState();
}

class _AcademicRecordsWidgetState extends State<AcademicRecordsWidget>
    with TickerProviderStateMixin {
  late AcademicRecordsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AcademicRecordsModel());
