...
import 'grievances_h_o_d_model.dart';
export 'grievances_h_o_d_model.dart';

class GrievancesHODWidget extends StatefulWidget {
  const GrievancesHODWidget({super.key});

  @override
  State<GrievancesHODWidget> createState() => _GrievancesHODWidgetState();
}

class _GrievancesHODWidgetState extends State<GrievancesHODWidget>
    with TickerProviderStateMixin {
  late GrievancesHODModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GrievancesHODModel());
