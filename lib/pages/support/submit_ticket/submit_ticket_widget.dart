...
import 'submit_ticket_model.dart';
export 'submit_ticket_model.dart';

class SubmitTicketWidget extends StatefulWidget {
  const SubmitTicketWidget({super.key});

  @override
  State<SubmitTicketWidget> createState() => _SubmitTicketWidgetState();
}

class _SubmitTicketWidgetState extends State<SubmitTicketWidget>
    with TickerProviderStateMixin {
  late SubmitTicketModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SubmitTicketModel());
