...
import 'book_event_model.dart';
export 'book_event_model.dart';
...
class _BookEventWidgetState extends State<BookEventWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BookEventModel());
            ...
            children: [
              Stack(
                children: [
                  ...
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(0.0, 280.0, 0.0, 84.0),
                    child: Column(
                      mainAxisSize: MainAxisSize.max,
